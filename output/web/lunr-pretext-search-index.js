...
{
  "id": "sec_fermi_estimation",
  "level": "1",
  "url": "sec_fermi_estimation.html",
  "type": "Section",
  "number": "2.1",
...
},
{
  ...
  "level": "1",
  "url": "sec_lying_with_visuals.html",
  "type": "Section",
  "number": "2.3",
...
},
{
  ...
  "level": "1",
  "url": "sec_reading_questions.html",
  "type": "Section",
  "number": "2.5",
...
{
  "id": "environmental-justice-objectives",
  "level": "1",
  "url": "environmental-justice-objectives.html",
  "type": "Section",
  "number": "6.1",
  "title": "Objectives",
  "body": " Objectives  By the end of this module students will be able to:  Describe the scale of global greenhouse gas emissions.  Compare the quantity of emissions between individuals, corporations, and nation states.  Model the greenhouse effect with varying levels of greenhouse gases.  Create data visualizations of both quantitative and qualitative data related to greenhouse gas emissions.  Evaluate strategies for reducing emissions using quantitative tools.  Discuss the consequences of failing to cut greenhouse gas emissions.  Propose actions to mitigate emissions in your personal life, institution, and nation    "
...
},
{
  "id": "p-572",
  "level": "2",
  "url": "sec-leg-visualize.html#p-572",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "crossing over "
...
},
{
  "id": "p-591",
  "level": "2",
  "url": "sec-leg-visualize.html#p-591",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "sec_learning-obj_gerry",
  "level": "1",
  "url": "sec_learning-obj_gerry.html",
  "type": "Section",
  "number": "8.1",
  "title": "Objectives",
  "body": " Objectives  By the end of this section, an engaged learner will be able to:    understand    perform    create    create    Analyze    compute      use    use    understand how    "
},
{
  "id": "sec_cui_bono_gerry",
  "level": "1",
  "url": "sec_cui_bono_gerry.html",
  "type": "Section",
  "number": "8.2",
  "title": "Who benefits from districting unfairly?",
  "body": " Who benefits from districting unfairly?   But why do we have this?  In the US we have districts.   "
},
{
  "id": "sec_districting_requirements",
  "level": "1",
  "url": "sec_districting_requirements.html",
  "type": "Section",
  "number": "8.3",
  "title": "What makes a good district?",
  "body": " What makes a good district?   Analyze the different measures we have the complexity. Talk about some of the requirements states have for districting. Discussion idea: have students google their favorite states requirements for homework before class and identify at least one requirement. Then discuss how they think math could be used to measure that (or if that's even possible\/why do they think so).  Make an exercise around Then use this exercise to motivate students to discuss their own rules of \"fairneess\" for a district.  Discussion idea: Brainstorm ideas you think would make a good measurement of compactness (how not spread out the data is). See W3A of AMS gerrymandering for more discussion topic ideas.   Classical measurements of \"unfair\"  Polsby-Popper    "
},
{
  "id": "sec_graphs",
  "level": "1",
  ...
  "type": "Section",
  "number": "8.4",
  "title": "Graph essentialss",
  "body": " Graph essentialss  "
},
{
  "id": "sec_modeling_districts",
  "level": "1",
  "url": "sec_modeling_districts.html",
  "type": "Section",
  "number": "8.5",
  "title": "How do we measure if districts are doing what we want?",
  "body": " How do we measure if districts are doing what we want?   blurblur  Return to and use it to analyze proposed district plans. Have students use what they learned in the prior chapters along with this tool to decide what is \"unfair\" and what is \"fair.\"   "
},
{
  "id": "sec_reading_questions_gerry",
  "level": "1",
  "url": "sec_reading_questions_gerry.html",
  "type": "Section",
  "number": "8.6",
  "title": "Reading Questions",
  "body": " Reading Questions   ???????      "
},
{
  "id": "exercise-100",
  "level": "2",
  "url": "sec_reading_questions_gerry.html#exercise-100",
  "type": "Exercise",
  "number": "8.6.1",
  "title": "",
  "body": ""
...
{
  "id": "refs-modeling-democacy",
  "level": "1",
  "url": "refs-modeling-democacy.html",
  "type": "References",
  "number": "8.7",
  "title": "References",
  "body": " "
...
{
  "id": "sec-fermi-estimation",
  "level": "1",
  "url": "sec-fermi-estimation.html",
  "type": "Section",
  "number": "9.1",
  "title": "Fermi Estimation",
  "body": " Fermi Estimation   Discussion - Bob Moses & Math Literacy    1 . (TPS; Reading Question ) Bob Moses is a veteran of the Civil Rights Movement and a former leader of the Student Nonviolent Coordinating Committee (SNCC), a major Civil Rights Movement organization dedicated to community organizing. He is also a math educator and founder of the Algebra Project, which works to promote mathematical literacy among low-income students and students of color. Please read the attached chapter  from Moses’ book, Radical Equations , entitled Algebra and Civil Rights . While reading, think about your sense of the connections between mathematics and civil rights, equity, fairness, and justice. Then answer the questions below.   What is Ella Baker’s definition of radical in the quote at the beginning of the chapter? How is Baker’s definition similar to or different from your own?     What is Ella Baker’s definition of radical in the quote at the beginning of the chapter? How is Baker’s definition similar to or different from your own?    In your own words, why does Moses believe that the most urgent social issue affecting poor people and people of color is economic access and that economic access and full citizenship depend crucially on math and science literacy (p. 5)?    How do you react to Moses’ assertion that not being ’good’ in math does not in any way imply inferiority, rather, it confirms that you’re just like most everyone else (p. 10)? How does this assertion connect to growth mindset and productive failure?    How have the issues Moses discussed changed since his book was published in early 2002? How have they stayed the same?    In what ways is Moses’ approach to the Algebra Project similar to and different from his approach to the civil rights movement? Explain.    In your own words, is learning mathematics important for civil rights, fairness, and social justice? Why or why not?      For class discussion:    Other than mathematical literacy, what other important civil rights and social justice issues impact low-income people and people of color in contemporary society? How might we use math to address those issues? We’ll try to find ways.    What groups other than low-income folks and people of color are being underserved in math literacy education? Explain.    Is algebra still the gatekeeper of the math curriculum?    Importance of tutoring and Westminster’s tutoring collaborations          Reading the News Week 1    Post links to your articles please!    Many people looked up statistics and just compared the statistics they found online to each other. This is valid, but the goal of this and other assignments on estimation is to be able to practice estimating more complex or unavailable data quickly, on the back of an envelope . I went easy this time, but on our in-class work today, try not to use the Internet to look up statistics.      Top vote-getters in discussion poll    Class & income inequality    Four-way tie:    3) human trafficking    environmental justice    how math perpetuates inequality    1) racial justice    2) LGBTQ+ issues        2 . Take a ranked-choice class vote between these four. Voters pick a first-choice candidate and have the option to rank backup candidates in order of their choice: second, third, and so on. If a candidate receives more than half of the first choices, that candidate wins, just like in any other election. However, if there is no majority winner after counting first choices, the race is decided by an instant runoff. The candidate with the fewest votes is eliminated, and voters who picked that candidate as ‘number 1’ will have their votes count for their next choice. This process continues until a candidate wins with more than half of the votes.     News update: fivethirtyeight election forecasts    3 . how do these forecasts estimate the likelihood of Biden winning the 2020 election? How much do we trust them? We’ll dig into their (simulation-like) methodology later in the course and find out!  In the wake of the mass shooting last Saturday, August 31, in Odessa, TX, mass shootings are once again in the national consciousness. (for how long?) Read over the poll at https:\/\/tinyurl.com\/HuffPollGuns and answer the following questions:    What surprises you about the results to this poll?    This poll was taken between August 5-6, 2019. What happened near that date that might have affected the results of the poll?    August 3: El Paso anti-immigrant mass shooting    August 4: Dayton, OH, mass shooting killing 9      This was a poll of people. If you were conducting the poll, how would you determine whether these people’s views matched those of the whole United States? If you were choosing the people, how would you choose them?    Throw darts at a phone book? Great!    Find people just hanging out outside?           4 . [RQ: Is math everywhere?]    What arguments does Barany give against the statement math is everywhere? How would you reply to his arguments?    What arguments does Haensch give that math is still everywhere? How would you reply to her arguments?    After reading both articles, what perspective do you have on the way(s) mathematics interacts with society, power, and oppression?    Haensch argues that Barany’s arguments do not support the title of his blog post. Do you agree? Why or why not? If you agree, how would you retitle Barany’s piece?         5 . [Reading Question: CSM Exercise 1.8.2] In his May 17, 2010 op-ed column in The New York Times Bob Herbert noted that the dropout rate for American high school students was one every 26 seconds. [R10] Is this number reasonable?    Let’s estimate.    First, how many American high school students are there? We’ll assume this corresponds with the proportion of Americans between ages and , inclusive. This is probably between and of Americans.    We use a geometric mean to get a single estimate:     around (guess) of Americans, and there are about million Americans, so we estimate that there are American high-school students each year. Our answer here is tens of millions , which fits with the actual number of about million. [Note that we don’t round; we just count the number of zeroes, which here is , meaning our answer is tens of millions .]    Assume that (perhaps a high estimate) of American high-school students drop out each year. That’s dropouts per year.    We convert to dropouts per second:     Finally, we compute which is higher (rounded up) than Herbert’s estimate. However, we note that we purposefully overestimated the dropout rate in order to be generous to Herbert’s estimate, so we could easily be off by a factor of ( vs. dropouts per seconds).      Fermi Estimation    In order to verify claims made in the media, to compute how much sea level rise would be associated with a rise in global sea temperature, or to test whether the claims Trump makes in his next State of the Union address are correct, it’s essential to have an ability to estimateto lie (or oversimplify) skillfully and in a way that lets us better understand the truth.    I make many mistakes on this type of problem until I think it through carefully!]    Tools for back-of-the-envelope calculations aka Fermi estimation     Estimation round up or down to make calculations easier and numbers less messy. As we saw when estimating the number of classrooms needed for the US household wealth, rounding before the computation ends can introduce error. Therefore, if you have a calculator, it’s best to plug into the calculator before rounding, whereas if you’re computing by hand, rounding may be necessary in order to increase the accuracy of your computations. Everyone makes arithmetic mistakesyou’ll see me do it plenty of times!     Dimensional analysis : start with the given and multiply by fractions, canceling out the units, until you get something in the units your answer should be in. This is almost always your answer!     Only guess up to an order of magnitude , i.e. the number of zeroes.      Why bother with Fermi estimates, if your estimates are likely to be off by a factor of 2 or even 10? Often, getting an estimate within a factor of 10 or 20 is enough to make a decision. So Fermi estimates can save you a lot of time, especially as you gain more practice at making them.      6 . Can we say for sure that there were less than million internatinoal phone calls per day in ?      Nope! We only can be accurate up to, at most, an order of magnitude that is, there were probably millions but not billions of international phone calls made by Americans per day in .      We can say our estimate is or , but the only part we’re fairly sure about is the eight zeroes, the .       Reading Questions: WMD Intro    7 . Please read the Introduction of Weapons of Math Destruction, by the data scientist Cathy O’Neil (Links to an external site.)Links to an external site., then give the following questions your best attempt. Bring your answers to class for discussion.    According to O’Neil, what is a weapon of math destruction?    a model that manages our lives and tends to reproduce social inequities or inherit prejudice from its programmers\/source datasets      What paradox does O’Neil note about the standard of evidence WMDs are held to as opposed to humans? How might this paradox lead to social injustice?    They’re black-boxed and need provide less evidence to justify profiling a person than that person must provide to exonerate themselves      According to O’Neil, in what ways do WMDs differ from the effective use[s] of statistics in Google ad testing?    not enough controls\/variables to monitor    no feedback from testing certain variables to conclude that they don’t affect the outcome     the privileged...are processed more by people, the masses by machines       What payoff do the companies who make WMDs receive for their effort? According to O’Neil, how does this payoff lead to a dangerous confusion?    they get lots of money and think it’s because they’re on the right track    they lose track of the people on the receiving end of the transaction       What question(s) do you have about data science, statistical models, and WMDs after reading the introduction to O’Neil’s book?      Tips for estimation:    Change the rules to make arithmetic easier. There weren’t exactly million Americans in the actual population was something like million. But since we’re just giving an estimate anyway, we don’t care about the . We round to the nearest hundred million!    For this reason, we only care about how many zeroes your answer has, not the actual number. So for our purposes and are the same because they give us the answer of millions .      Writing all those zeroes can get unwieldy, so we use scientific notation : with zeroes after it is the same as . Nine with seventy zeroes after it is written .     Divide and conquer : split the problem up by first figuring out all the things we need to know, then using those things in some order to get an answer.     Use ranges. If you feel fairly confident that there are between and Americans who don’t like Harry Potter (between and in scientific notation), average the exponents and the single-digit numbers to get your estimate. Here we’d average and to get and and to get , so your answer would be Americans.    This is called taking a geometric mean , which is easier to take than a regular average when dealing with big numbers and exponents.       Look up related data , if it’s available, to check the reasonableness of your estimation. For example, when estimating the number of active COVID-19 cases in SLC, you could look up scientific estimates of the proportion of COVID-19 cases that are reported, multiply that proportion by the population of SLC, and see if it’s in the same ballpark (same number of zeroes) as your estimate.        9 . (Worksheet on Canvas) Estimation. No computers\/looking up allowed bc the goal is to practice a skill that is useful when we don’t have real-world data! Divide the students into teams of 3-4. Each team starts on one of the first seven estimates with instructions to move on to the next one when done, circling back to Google search if they reach the end of the list. The teams start in different places, so after about half an hour the class has found two or three estimates for each of the seven tasks. The different answers for each task should have the same order of magnitude. If they don’t, we try to figure out why not. (Good to have poster paper or whiteboards for this)    Annual income for full-time Utah minimum wage worker.    Federal (and Utah) minimum wage is \/hour. Round to to make the math easier (we only care about the number of zeroes in our answer, so this should turn out fine).    A full-time worker works hours\/week.    There are weeks in a year.    Thus the annual income is approximately It’s in the tens of thousands of dollars. Notice how all the units cancel out and the answer is in dollars per year, as desired, while our given information was in dollars per hour. At each step, we’re converting from one unit to another (dollars\/hour to dollars\/week to dollars\/year).    Real answer (for federal\/Utah minimum wage): also in the tens of thousands! Note how close our answer is. This is because our rounding (up and down) canceled itself out.      Average Westminster student’s household (family) income.    Mean or median?    Can we agree that the answer should be higher than ?    Should it be a whole order of magnitude (ten times) higher? That would make the average Westminster student’s family income or above. This is probably a bit overgenerous, so our answer should be .    https:\/\/tinyurl.com\/WMIncome: real median household income (according to anonymous tax records; is this representative?) is ; we were very close!      Average University of Utah student’s household (family) income    Can we assume that the average U student’s family income is less than of a Westminster student’s family income? That would put it around , so in the tens of thousands of dollars.      Number of active COVID-19 cases in Salt Lake City. (Not just confirmed cases.)    By some estimates, only of COVID cases are reported.    8 . How could we verify this using a scientific study?     According to an article published in JAMA Internal Medicine , ”From comparing the number of estimated cases to reported case figures on the last day of sample collection, the study’s authors estimated that there were six times as many COVID-19 infections in Connecticut, the lowest figure, and potentially 24 times the number of infections in Missouri than were reported.”    This cross-sectional study performed serologic testing on a convenience sample of residual sera obtained from persons of all ages.        Number of active COVID-19 cases among Westminster students. (Not just confirmed cases.)    Percentage of active COVID-19 cases in Salt Lake City that occur in people of color.    According to the CDC, ”Non-Hispanic American Indian or Alaska Native persons and non-Hispanic Black persons had age-adjusted hospitalization rates approximately 4.7 times that of non-Hispanic White persons. The rate for Hispanic or Latino persons was approximately 4.6 times the rate among non-Hispanic White persons.”      Average tax rate for an American in the wealthiest .    We use the given facts; first, we note the average American in the wealthiest earns million per year, of which ( million) is made in capital gains. This means million is not made from capital gains and is taxed at the higher tax rate.    The tax on the capital gains portion of income is easier to estimate:     The tax rate on the non-capital gains income would be plus of the amount over . Since the non-capital gains income totals , the amount over is million. So the tax on the non-capital gains income would be     Thus, the total tax paid by the average member of the is . To find the tax rate paid, we have to figure out what percent of their income this average -percenter paid. They paid in taxes, and their income was million, so they paid a tax rate of       Average tax rate for an American teacher.    The average teacher earns a year. This means their tax rate is plus of the amount over . Since there’s no amount over , this teacher pays in taxes.     is or of the teacher’s income of .      Is Joe Biden’s statement reasonable?    The teacher’s tax rate looks at first glance to be smaller than the top er’s tax rate, but note we estimated. Both of our answers are in ”tens of thousands”, so we can’t    Due to potential estimation error, it’s actually reasonable that Biden’s statement is true.      Average number of Americans who die each day due to mass shootings.    How to define a mass shooting ?    No official definition: at least killed? injured? Including shooter or not? Including violence due to drugs\/gangs?    Estimate the number of mass shootings in : between and . Take the geometric mean: .    Estimate the number of Americans killed in each mass shooting: say on average. So a total of Americans are estimated to have been killed by mass shootings in .      Number of Americans killed by undocumented immigrants in .    Note that no data exists.    Given that there were murders total, we need to estimate the number of undocumented immigrants in the US in , as a percentage of the population. Say between and , with geometric mean . Very close to the real number!    You may have heard the (true) claim that undocumented Americans commit crimes at a lower rate than documented Americans.    Even if you assume the rate is the same, that means that of the murders, or murders were committed by undocumented immigrants in .    Both the mass shooting and murder numbers are in the hundreds, so there’s absolutely no evidence for the tens of thousands claim made in the post.      # of Americans arrested each second for possession of weed alone from 2001-2010.    We know about Americans were arrested for weed alone in . Assuming weed policies were more lenient in than in , we’d guess maybe an average of at most Americans a year over this -year period, for a total of Americans arrested.    We now estimate seconds\/year:     This means that there were or about one arrest every sec.    Now note that multiple people could be swept up in a single pot bust. Assume people on average per bust, that gives or busts every sec. This is on the same order of magnitude as the ACLU’s estimate, so their estimate is reasonable.           10 . [or next time] Please read Sections 2.1-2.2 of Common Sense Mathematics, on units and MPG, then answer the following questions. Bring your answers to class on the date below for discussion.    There are about 3.8 liters in a gallon and about 1.6 kilometers in a mile. If a car can travel 30 miles for every gallon of gas it burns, approximately how many kilometers can it travel per liter of gas? Just like in Section 2.1 of Common Sense Mathematics, write out your units and cancel units just like you would cancel zeroes in a fraction. Hint: start with . Then multiply by a number with units in order to cancel the miles and replace it with kilometers.    If a car can travel 30 miles per gallon of gas, how many gallons of gas does the car need to travel one mile? Show all work and units, cancelling units when needed.    If a car can travel 30 miles per gallon of gas, how many liters of gas does the car need to travel one kilometer? Show all work and units, cancelling units when needed.    If you were looking to buy a new car, what, if anything, does reading Section 2.2 change about what you’d consider before buying? Explain.     "
},
{
  "id": "p-651",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-651",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "1 Reading Question "
},
{
  "id": "question-1",
  "level": "2",
  "url": "sec-fermi-estimation.html#question-1",
  "type": "Question",
  "number": "9.1.1",
  "title": "",
  "body": " What is Ella Baker’s definition of radical in the quote at the beginning of the chapter? How is Baker’s definition similar to or different from your own?  "
},
{
  "id": "p-680",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-680",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "2 Voters pick a first-choice candidate and have the option to rank backup candidates in order of their choice: second, third, and so on. If a candidate receives more than half of the first choices, that candidate wins, just like in any other election. However, if there is no majority winner after counting first choices, the race is decided by an instant runoff. The candidate with the fewest votes is eliminated, and voters who picked that candidate as ‘number 1’ will have their votes count for their next choice. This process continues until a candidate wins with more than half of the votes. "
},
{
  "id": "p-681",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-681",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "3 "
},
{
  "id": "p-694",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-694",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "4 "
},
{
  "id": "p-701",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-701",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "5 "
},
{
  "id": "p-710",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-710",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Estimation Dimensional analysis Only guess up to an order of magnitude "
},
{
  "id": "p-719",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-719",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "6 "
},
{
  "id": "p-723",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-723",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "7 "
},
{
  "id": "p-741",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-741",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "round and are the same scientific notation Divide and conquer Use ranges. geometric mean Look up related data "
},
{
  "id": "p-753",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-753",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "9 No computers\/looking up allowed bc the goal is to practice a skill that is useful when we don’t have real-world data! "
},
{
  "id": "p-754",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-754",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "8 convenience sample "
},
{
  "id": "p-816",
  "level": "2",
  "url": "sec-fermi-estimation.html#p-816",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "10 "
...
},
{
  "id": "p-835",
  "level": "2",
  "url": "sec_annotated-bib.html#p-835",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Questions "
},
{
  "id": "p-837",
  "level": "2",
  "url": "sec_annotated-bib.html#p-837",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-842",
  "level": "2",
  "url": "sec_annotated-bib.html#p-842",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-846",
  "level": "2",
  "url": "sec_annotated-bib.html#p-846",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-849",
  "level": "2",
  "url": "sec_annotated-bib.html#p-849",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-852",
  "level": "2",
  "url": "sec_annotated-bib.html#p-852",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-855",
  "level": "2",
  "url": "sec_annotated-bib.html#p-855",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-858",
  "level": "2",
  "url": "sec_annotated-bib.html#p-858",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-861",
  "level": "2",
  "url": "sec_annotated-bib.html#p-861",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-864",
  "level": "2",
  "url": "sec_annotated-bib.html#p-864",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-867",
  "level": "2",
  "url": "sec_annotated-bib.html#p-867",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-870",
  "level": "2",
  "url": "sec_annotated-bib.html#p-870",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-873",
  "level": "2",
  "url": "sec_annotated-bib.html#p-873",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-876",
  "level": "2",
  "url": "sec_annotated-bib.html#p-876",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-879",
  "level": "2",
  "url": "sec_annotated-bib.html#p-879",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-882",
  "level": "2",
  "url": "sec_annotated-bib.html#p-882",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-885",
  "level": "2",
  "url": "sec_annotated-bib.html#p-885",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-888",
  "level": "2",
  "url": "sec_annotated-bib.html#p-888",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-891",
  "level": "2",
  "url": "sec_annotated-bib.html#p-891",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-894",
  "level": "2",
  "url": "sec_annotated-bib.html#p-894",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-897",
  "level": "2",
  "url": "sec_annotated-bib.html#p-897",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
