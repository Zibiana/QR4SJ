...
class Rotor:
    ...
    def __init__(self, rotor_num, window_letter, next_rotor=None, prev_rotor=None):
        if rotor_num == 'I' or rotor_num == 'II' or rotor_num == 'III':
            ...
            print('Please select I, II, or III for your rotor number and provide the initial window setting (i.e. the letter on the wheel initially visible to the operator.')
            return None
